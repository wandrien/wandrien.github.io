...
* Обучение модели MoE требует особых техник, чтобы избежать коллапса экспертов. Их детальное изучение - на данный момент вне интересующих меня вещей.
